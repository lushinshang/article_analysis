# 狂飆的算力帝國與失焦的道德羅盤：解讀 2026 年 Alphabet 股東大會的繁華與暗流

> 📅 **會議日期**：2026 年 6 月 5 日（星期五）太平洋時間上午 9:00  
> 🔗 **來源影片**：[Alphabet 2026 Annual Meeting of Shareholders (YouTube)](https://www.youtube.com/watch?v=WIEJ6n-bH78)  
> 🗃️ **字幕來源**：`2026_Annual_Meeting_of_Shareholders_WIEJ6n-bH78.srt`  

---

## 1900 億美元的豪賭與一場「AI 奪命」訴訟
...
1. **物理資源的極限挑戰**  
   隨著 AI 數據中心的瘋狂擴張，Alphabet 的溫室氣體排放量在短短五年間暴增了 51%。更嚴峻的是水資源。AI 晶片的高發熱量需要海量淡水進行冷卻，股東提案指出，Alphabet 的數據中心有相當比例位於水資源匱乏的地區。這種對電力與水資源的「掠奪式消耗」，正在讓原本美好的「2030 年零碳排」承諾化為泡影。
   
2. **事實準確性的邊界崩塌**  
   雖然 Gemini 3 Pro 在官方的 Facts Leaderboard 上奪得頭籌，但其事實準確度（Factuality）依然只有尷尬的 69%。這意味著每三句回答中就有一句可能是幻覺。當這種技術被嵌入到月活躍用戶達 25 億的 AI Overviews 搜尋中時，每天都在產生數以億計的錯誤資訊。從醫學文獻的憑空捏造，到癌症治療建議的致命偏差，AI 正在將「低成本散播謬誤」變成一種日常。

3. **人權與安全監管的自我閹割**  
   為了追求利潤最大化，Alphabet 在 2025 年進行了一次極具爭議的「治理重組」——將人權與民權的監督職能從董事會審計委員會章程中徹底刪除。這種在制度上自我鬆綁的行為，直接導致了技術被濫用於高風險領域（如邊境管制與戰場監視）的局勢升級。
...
這套戰略的恐怖之處在於，它不單單是在賣一個聊天機器人，而是將 AI 轉化為像電力一樣的基礎設施。透過 **Universal Cart（通用購物車）**，消費者可以流暢地在 Gmail、YouTube、Gemini 和 Search 之間完成購買，將流量直接變現；而在企業端，**Google Cloud** 凭借著唯一提供「基礎設施 + GCP + Workspace + 安全」全棧方案的優勢，實現了 Q1 營收增長 63% 的驚人跨越，且首次讓企業 AI 應用成為雲端部門的第一大成長引擎。
...
### 管理層與董事會代表
* **John Hennessy**（董事會主席）  
  * **發言大綱**：主持會議、宣示 Alphabet 在 AI 領域的驚人創新，回顧 2025 年推出 Gemini 3 以及成立獨立「風險與合規委員會」以加強監管風險治理的進展。
* **Sundar Pichai**（執行長 / CEO）  
  * **發言大綱**：發表戰略報告。提出業務營收（突破 4000 億美元）、技術底座（八代 TPU、Gemini 3.5、Nano Banana、Antigravity 平台）、產品滲透（AI Overviews、Universal Cart）以及 Google Cloud（營收增長 63%）的領先優勢。同時宣布為奠定長期基礎設施，已完成約 850 億美元的增資。
* **Kathryn Hall**（公司助理秘書）  
  * **發言大綱**：負責大會法定程序，宣讀出席率與法定人數，宣佈董事名單與官方提案，並公布最終表決結果。

### 股東提案代表
* **Andrea Ranger**（Trillium Asset Management 股東倡議總監）  
  * **提案內容 (Proposal 5)**：要求公開氣候轉型計劃。質疑 AI 暴增使 Alphabet 排放量五年間大漲 51%，如何達成 2030 年減排 50% 目標。
* **Tim Schwarzenberger**（Inspire Investing 投資組合經理）  
  * **提案內容 (Proposal 6)**：要求揭露數據中心水資源短缺風險。AI 耗水冷卻對敏感缺水地區構成財務與營運中斷隱患。
* **Tahlia Kirk**（Alphabet Workers Union 成員 & 承攬商講師）  
  * **提案內容 (Proposal 7)**：提出「一股一票」股權重組。抗議 Page 與 Brin 持股僅 11% 卻控制 53% 投票權。控訴佔 Google 半數勞動力的 TVC 外包影子工人遭到不公平對待與裁員。
* **Steve Milloy**（Free Enterprise Project 執行董事）  
  * **提案內容 (Proposal 8)**：要求觀點多樣性報告。指控 YouTube 存在政治審查，對去貨幣化氣候懷疑論者的觀點進行歧視。
* **Stefan Padfield**（Heritage Foundation 自由企業倡議負責人）  
  * **提案內容 (Proposal 9)**：要求評估使用政治化第三方審查指標的風險。指控 Google 在內容審查上依賴偏向左派的組織（如 SPLC），缺乏客觀性。
* **Lu Liu**（SOC Investment Group 代表 & AWU 成員）  
  * **提案內容 (Proposal 10)**：要求評估美國移民政策與簽證變更對營運的衝擊。指出 2026 年 Q1 H-1B 簽證申請因政策與費用問題大幅減半。
* **John Palowitch**（前 Google DeepMind 研究科學家）  
  * **提案內容 (Proposal 11)**：要求評估 AI 與雲端技術被客戶（如軍方或邊境管理局）濫用的風險。抗議 Nimbus 專案，指控公司刪除 AI 不用於武器之原則。
* **Serena Chan**（SHARE 股東權益倡議專家）  
  * **提案內容 (Proposal 12)**：要求在審計委員會章程中恢復 AI 與人權的正式監督職責。指出人權監督條款在 2025 年被悄悄撤銷。
* **Edmond Ho**（Vancity Investment Management）  
  * **提案內容 (Proposal 13)**：要求委託第三方評估如何防範 Google 產品傳播假訊息。指出 Gemini 的錯誤率高達 30%，並在搜尋中每天放大數千萬次錯誤。
* **Paul Chesser**（National Legal and Policy Center）  
  * **提案內容 (Proposal 14)**：要求每年發布 AI 外部數據使用的道德與法律風險報告。提及 12 個月內付出的 19 億美元隱私和解金，以及 Gemini 誘導青少年自殺的非正常死亡官司。
...
| **Proposal 9** | **使用第三方政治化審查指標的風險報告** | 反對 | **【否決】** | 審視依賴第三方非政府組織進行言論 moderation 的偏見。 |
...
| **Proposal 14** | **AI 外部數據使用與隱私風險報告** | 反對 | **【否決】** | 要求針對隱私侵犯和解（19億美元）與教唆自殺诉讼提出報告。 |
...
今年，Alphabet 在各方面都取得了長足的進展。董事會對於公司上下的創新與績效感到振奮。隨著 AI 在全球普及，Alphabet 持續將世界領先的技術轉化為對用戶、企業和社群有益的工具與值得信賴的體驗。公司在 2025 年達成多項重要里程碑，包括推出了最先進的 Gemini 3 模型。公司正運用 AI，在搜尋及其他核心產品中打造更實用的體驗。這也有助於 Google Cloud 深化與使用其基礎設施和產品的客戶關係。還有更多精彩之處。所有這些動能，都在最近的年度開發者盛會 Google/IO 上精彩呈現。Sundar 稍後會分享更多細節。
...
### 🗣️ 安德里亞·蘭傑 (Andrea Ranger - Trillium 代表)
...
最後，鑑於公司 extensive 的資本規劃努力、氣候「登月計畫」以及整體技術的精密性，我們認為準備和發布上述揭露內容，是一項合理且實際的要求。事實上，在 AI 模型、訓練和測試、微晶片以及儲存它們的資料中心上投入的數十億美元，要求 Alphabet 的計畫能夠更加透明，而不是更加模糊。

感謝您的時間和關注，以及對第 5 號提案的支持。

### 🗣️ 凱瑟琳·霍爾 (Kathryn Hall - 助理公司秘書)

謝謝。接下來的股東提案是由 Inspire Investing, LLC 代表其客戶提出的。提案人已提交一段預錄的簡報以支持此提案。現在，我邀請 Tim Schwarzenberger 先生發言三分鐘，介紹此提案。

### 🗣️ 蒂姆·施瓦岑貝格爾 (Tim Schwarzenberger - Inspire 代表)
...
謝謝。接下來的股東提案是由 NorthStar Asset Management, Inc. 的儲蓄年金計畫（為主要提案者）以及 Mercy Investment Services, Inc.（為共同提案者）所提出。提案者已提交一段預錄的簡報來支持這項提案。我現在邀請 Tahlia Kirk 發言三分鐘，來介紹這項提案。

### 🗣️ 塔莉亞·柯克 (Tahlia Kirk - NorthStar & AWU 代表)
...
謝謝。下一份股東提案是由 National Center for Public Policy Research 提出的。提案人已提交預錄的簡報來支持這項提案。現在我請 Steve Milloy 在三分鐘內進行提案說明。

### 🗣️ 史蒂夫·米洛伊 (Steve Milloy - Free Enterprise 代表)
...
謝謝。接下來的股東提案是由 Bowyer Research, Inc. 代表 The Heritage Foundation 提出。提案人已提交一段預錄的簡報來支持這項提案。我現在請 Stefan Padfield 進行三分鐘的提案說明。

### 🗣️ 史蒂芬·帕德菲爾德 (Stefan Padfield - Heritage Foundation 代表)

我是 Stefan Padfield，隸屬於 Heritage Foundation 的 Free Enterprise Initiative 的負責人。Heritage Foundation 是第九號提案的發起方，該提案要求報告 Alphabet 使用由政治化企業夥伴所創建的診斷工具的風險。我們提案中識別出的相關警示訊號之一，是 Alphabet 在 YouTube 的仇恨言論政策上，與 Southern Poverty Law Center (SPLC) 合作。值得注意的是，我們的提案是在 SPLC 被司法部起訴之前提交的。然而，我們的提案中已清楚說明，對於這起起訴，任何人都不應感到意外，因為這起訴在某種程度上，僅僅證實了長久以來外界的懷疑，即 SPLC 顯然已經變成一個反保守派的抹黑工廠，危及生命，並且煽動著它聲稱正在對抗的仇恨。舉一個例子，Tyler O'Neil 的書《Making Hate Pay: The Corruption of the Southern Poverty Law Center》於 2020 年出版。雖然 Alphabet 聲稱其反對 SPLC 的聲明並非 YouTube 的優先標記項目，但令人費解的是，Alphabet 並未確認其與 SPLC 沒有其他相關聯繫。同樣地，Alphabet 指出它會從廣泛的第三方專家和非政府組織接收資訊，但聲稱這些組織不做出移除內容的決策。然而，Alphabet 如何確保這些資訊不存在偏見，無論是在資源分配方面，還是在最終決策整合方面？鑑於 Alphabet 在 Alliance Defending Freedom 的觀點多元性計分商業指數中僅獲得 6% 的分數，並且在 1792 Exchange 的企業偏見評級中被列為高風險，原因似乎包括企業領導層存在 17 比 1 的反共和黨捐款偏見，這似乎是一個合理的問題。此外，以下是來自 Media Research Center 的幾則近期相關新聞標題，進一步增加了警示訊號：2025 年 10 月 20 日：Google 依賴聲名狼藉的 SPLC 來攻擊川普盟友。2026 年 4 月 8 日：特別報導，183-6。Google 新聞在伊朗戰爭報導中壓制右翼媒體。2026 年 4 月 9 日：Google AI 洩漏訊息。左派守門員共識控制 Gemini 的來源。2026 年 4 月 17 日：美國數十年前就將真主黨列為恐怖組織。Gemini 卻不這麼說。最後，一組 16 位州檢察長於 2026 年 2 月 17 日就 YouTube 的內容審核實務，向 Alphabet 發送了一封信，信中指出，儘管 YouTube 聲稱保持中立，但它持續壓制保守派的聲音。上述這些警示訊號明確顯示，董事會應當履行其信託義務，進行監督，並重新審視 Alphabet 對政治化內容審核指標的使用。

### 🗣️ 凱瑟琳·霍爾 (Kathryn Hall - 助理公司秘書)

謝謝。接下來是 SOC Investment Group 提出的股東提案。現在我請 Lu Liu 先生發言，時間為三分鐘。劉先生，時間快到時我會提醒您。接線員，請接通劉先生的線路。

### 🗣️ Operator

劉先生，您的線路已接通。

### 🗣️ 陸劉 (Lu Liu - SOC & AWU 代表)
...
謝謝劉先生。下一項股東提案由 Zevin Asset Management 代表主要提案人 Denise 和 Gerald Bergman  junto 其他共同提案人提出。我現在請 John Palowitch 先生發言，時限為三分鐘。Palowitch 先生，我會在您的時間快到時提醒您。操作員，請接通 Palowitch 先生的電話。

### 🗣️ Operator

帕洛維奇先生，您的線路已接通。

### 🗣️ 約翰·帕洛維奇 (John Palowitch - 前 DeepMind 科學家)

大家好，我是 John Palowitch。去年九月，我從 Google Research 和 Google DeepMind 研究科學家的八年職涯中辭職。我離職的動機，正是提案十一所提出的擔憂，也就是 Alphabet 的合約模式嚴重限制了公司對客戶在高風險情境下部署雲端及 AI 服務的監督能力，同時領導層又撤回了 AI 原則，允許軍事用途。每一位 Google 員工都被要求做到「Googley」，這大約意味著作為一個員工和世界公民，要保持誠實，負責任地行事。我認為，Googley 的決定就是對提案十一投下贊成票，提案十一只是要求一份關於 Alphabet 因潛在客戶濫用其 AI 和雲端技術所產生的風險報告。對股東們來說，最終的問題是 Alphabet 的風險管理系統，是否能跟上其涉及敏感工作負載的不斷擴大的合約組合的步伐。我和我的前同事們多年來一直在提出這些問題，指出從 2019 年開始向美國海關及邊境保衛局的承包商，以及自 2021 年起向以色列軍方提供的雲端服務。可惜的是，這些努力得到的不是沉默，就是領導層令人不安的矛盾。例如，在 2024 年 4 月，一位 Google 發言人告訴《時代》雜誌，Alphabet 與以色列的 Project Nimbus 合約並非針對高度敏感或機密軍事工作負載。然而，自那以後，多項獨立調查發現，以色列軍方承包商當時正在使用 Google 的 AI 模型進行監控。今年，Google 員工們提出請願，要求對 Alphabet 支持美國國土安全部大規模監控、未經正當法律程序而拘留平民，以及 DeepMind 研究人員在與美國國防部簽訂的極度寬容協議下，圍繞 AI 紅線進行的工會組織，要有更多透明度。如果沒有提案十一所要求的揭露，我懷疑將有數千名員工選擇離職或組織抗議，這將對 Alphabet 構成日益嚴重的財務和聲譽風險。除了留才風險外，所要求的揭露，也將進一步降低法律風險，潛在包括國際法風險，正如聯合國去年的里程碑式報告所指出的。正如我作為一名關心這些問題的員工時所注意到的，Alphabet 自身的人權聲明聲稱遵守聯合國關於工商業與人權的指導原則，這是一個要求與提案十一所要求的盡職調查報告完全相同的框架。Alphabet 反對意見中提到的現有報告，主要討論的是數據安全而非客戶濫用風險，都無法達到這個標準。總之，我懇請董事會依照要求每一位 Alphabet 員工的價值觀、與公司自身聲明的承諾一致，並為了 Alphabet 的品牌和營運利潤，投下贊成票。謝謝。

### 🗣️ 凱瑟琳·霍爾 (Kathryn Hall - 助理公司秘書)

謝謝 Palowitch 先生。接下來的股東提案是由「股東研究與教育協會」，代表「加拿大聯合教會退休金計畫」提出，該計畫是主要的提案者，並有其他共同提案者。現在我請 Serena Chan 發言三分鐘，就這項提案進行說明。Chan 小姐，時間快到了我會提醒您。請總機開啟 Chan 小姐的線路。

### 🗣️ Operator

陳女士，您的線路已接通。

### 🗣️ 陳塞麗娜 (Serena Chan - SHARE 代表)

各位股東，早安。我是 Serena Chan，來自股東研究與教育協會（SHARE）。今天我在此代表加拿大聯合教會 PSA 退休金計畫（Pension Plan of United Church of Canada PSA Pension）與 Parnassus Investments，提出並動議第 12 號提案。
...
隨著 Alphabet 持續在 AI 的開發與部署上進行大量投資，由董事會正式授權的 AI 監督，將能為 Alphabet 帶來：

一、在董事會層級建立一個正式的流程，系統性地監測 AI 的開發與部署、AI 相關風險，以及伴隨而來的人權影響。
二、設計 AI 相關風險的董事會層級升級路徑。
三、與 Alphabet 自身對於負責任 AI 的承諾，達到更大程度的契合。
四、與微軟（Microsoft）、eBay、思科（Cisco）和康卡斯特（Comcast）等同業，達到更大程度的契合。
...
謝謝 Chan 小姐。接下來的股東提案是由 Vancity Investment Management 提出。提案人已提交預錄簡報支持此提案。我現在有請 Edmond Ho 發言，有三分鐘的時間來介紹此提案。

### 🗣️ 何艾德蒙 (Edmond Ho - Vancity 代表)
...
根據公司數據，Gemini 技術也為 Google 的 AI Overviews 和傳統 Google 搜尋提供支援，觸及超過 20 億的月活躍用戶。根據《紐約時報》最近的分析，AI Overviews 的準確度約為十次有九次。然而，一年超過 5 兆次的搜尋量，相當於每小時就有數千萬筆的錯誤資訊。
...
謝謝。下一項股東提案是我們本次會議的最後一項議程，由國家法律與政策中心（National Legal and Policy Center）提出。提案人已提交一段預錄簡報以支持該項提案。現在，我邀請 Paul Chesser 使用三分鐘的時間來介紹這項提案。

### 🗣️ 保羅·切瑟 (Paul Chesser - NLPC 代表)

我是 National Legal and Policy Center 的 Paul Chesser。提案 numero 14 要求 Alphabet 做一件事：發布一份年度報告，說明其 AI 產品中，使用不道德或不當外部數據的風險。董事會拒絕了，說像是內部治理系統、選擇退出（opt-out）控制，以及貿易協會會員資格等，應該就足夠了。這個說法以前也許站得住腳，但現在不行了。
...
股東看不見的東西，就無法評估。這正是本提案想要改變的。我們敦促各位股東，支持提案 numero 14。謝謝。
...
我們堅信，目前的執行計畫與透明的資訊揭露，已能有效達成這些提案的實質目標，無需採取重複且量身打造的報告，或設定可能限制我們營運靈活度的僵化約束。感謝各位的深思熟慮與參與，請參閱 Alphabet 在委託書（Proxy Statement）中提供的詳細回覆，以作為您的投票決定之參考。
...
謝謝 Sundar。接下來，我們收到了一些關於基礎設施佈局的問題，具體來說：鑑於運算需求加速成長，公司正採取哪些措施，以確保我們的資料中心在設計與營運上能維持永續發展，特別是在能源與用水方面？
...
感謝 Sundar。好的，接著我們來看下一個議題。我們收到關於 Google Cloud 策略的提問。Sundar，Google Cloud 是如何做出市場區隔，以在企業級產品的競爭中脫穎而出並取得成效？

### 🗣️ 桑達·皮查伊 (Sundar Pichai - CEO)

如同我稍早提到的，Google Cloud 迎來了前所未有的明確機遇。各行各業、各種規模的企業都在選擇我們的雲端服務，全球成長最快速的 AI 新創公司也正透過我們的平台進行開發。我們是唯一能提供全方位企業級 AI 技術堆疊（Enterprise AI stack）第一方解決方案的供應商，範圍涵蓋了我們的 AI 基礎架構與模型、資料管理能力，以及 AI 代理（Agents）與應用程式等。
...
我們的績效充分反映了這種差異化優勢。在第一季財報中，我們提到受惠於對 AI 產品與基礎架構的強勁需求，雲端業務的成長與未結訂單（backlog）皆呈現加速。營收成長了 63%，首次突破 200 億美元大關；未結訂單則較上季幾乎翻倍，超過 4,600 億美元。同時，我們獲取新客戶的速度也在加快，新客戶的取得量較去年同期成長了一倍。

### 🗣️ 凱瑟琳·霍爾 (Kathryn Hall - 助理公司秘書)

謝謝 Sundar。最後，有幾位股東詢問關於董事會目前對於董事會組成及成員汰舊換新的做法。
