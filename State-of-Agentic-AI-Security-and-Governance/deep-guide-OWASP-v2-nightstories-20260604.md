# OWASP《代理式 AI 安全與治理狀態》v2.01 深度導讀：一千零一夜
> 來源：State of Agentic AI Security and Governance v2.01（2026）｜攻防一體視角
> 前置研究：OWASP-PreResearch.txt 互動式學習記錄
> 導讀視角：CyberSensei — 每個威脅都有對應的偵測線索、每道裂縫都有可貼的繃帶
...
![執行摘要三大發現：威脅已成現實 / Safety與Security融合 / 治理必須追上部署速度](pdf_images/State-of-Agentic-AI-Security-and-Governance-v2.01-1/picture-2.jpg)
...
![代理分類法：Agent Type × Implementation Pattern × Composition Pattern × Autonomy Level 完整三層架構圖](pdf_images/State-of-Agentic-AI-Security-and-Governance-v2.01-1/pdf-p13-agents-taxonomy.jpg)
...
![53 個 agentic repos 的 commit 速度 vs stars 分佈圖：OpenClaw 明顯離群，多數項目正在停滯](pdf_images/State-of-Agentic-AI-Security-and-Governance-v2.01-1/picture-21.jpg)
...
![Agentic Threat Landscape 2026：五大威脅全景——自主性擴張 / 提示注入 / 供應鏈武器化 / Vibe Coding & Shadow AI / 身分治理缺口](pdf_images/State-of-Agentic-AI-Security-and-Governance-v2.01-1/picture-9.jpg)
...
一、存取私人資料（Access to private data）
二、接觸不受信任的內容（Exposure to untrusted content）
三、對外通訊能力（Ability to communicate externally）
...
![Safety and Security, Governed Together：五個維度（威脅建模 / 事件分類 / 組織所有權 / 監控 / 法規報告）的現狀假設 vs 代理現實對照表](pdf_images/State-of-Agentic-AI-Security-and-Governance-v2.01-1/picture-10.jpg)
...
![CVE 趨勢折線圖：2023→2026 Q1 代理式 AI 安全事件數量爆炸性成長，MCP 啟動後曲線急升，2026 Q1 單季已 290+ CVE](pdf_images/State-of-Agentic-AI-Security-and-Governance-v2.01-1/picture-11.jpg)
...
![Agentic Identity Control Plane：Identity Assurance（Attestation/Provenance/Verifiable Credentials）× Authorization（Dynamic Access/Policy-as-Code/Delegation Constraints）× Governance（Lifecycle Automation/Audit & Attribution/NHI Risk Alignment）](pdf_images/State-of-Agentic-AI-Security-and-Governance-v2.01-1/picture-13.jpg)
...
Level 0：無防護——沒有政策，沒有監控，不知道部署了什麼。
Level 1：實驗期——有臨時規範和定期稽核，但沒有持續監控。
Level 2：政策定義——有明確風險政策，針對高風險行動強制加入人工審核。
Level 3：持續監控——有即時監控面板，幾秒內能切斷系統的 kill-switch，事件自動路由。
Level 4：自適應治理——系統能依據威脅自動調節代理的權限和邊界。
...
![Governance Posture Matrix（上）：AT0 Shadow AI × Level 0-4 到 AT2 Vendor Platform × Level 0-4 的治理狀態評估](pdf_images/State-of-Agentic-AI-Security-and-Governance-v2.01-1/pdf-p57-posture-matrix-1.jpg)

![Governance Posture Matrix（下）：AT3-AT5 公民開發者/程式執行 × Level 0-4 到 AT8 Federated × Level 0-4，含 CRITICAL GAP / DO NOT DEPLOY 紅色警示](pdf_images/State-of-Agentic-AI-Security-and-Governance-v2.01-1/pdf-p58-posture-matrix-2.jpg)

![How to use the Maturity Model：Step 0 發現 Shadow AI → Step 1 評估治理成熟度 → Step 2 依採用分級分類代理 → Step 3 查矩陣 → Step 4 依 ASI 風險優先化控制](pdf_images/State-of-Agentic-AI-Security-and-Governance-v2.01-1/pdf-p59-maturity-howto.jpg)
...
FinBot CTF 是 OWASP 為代理安全設計的第一個 Capture The Flag 練習環境，金融主題，對齊 ASI 風險類別。它不是測試你能不能讀懂 CVE 編號，而是讓你**用攻擊者的視角實際操作代理系統的弱點**。
...
![個人代理架構與 ASI 威脅映射：Gateway/Agent 核心 ↔ Skill Marketplace (ClawHub) ↔ Tool Execution ↔ Persistent Memory (SOUL.md/MEMORY.md) ↔ Messaging Platforms，各連線標注 ASI01-ASI09](pdf_images/State-of-Agentic-AI-Security-and-Governance-v2.01-1/picture-32.jpg)
...
*來源：OWASP State of Agentic AI Security and Governance v2.01（2026）*
*前置研究：OWASP-PreResearch.txt 互動式學習記錄*
*導讀框架：CyberSensei 攻防一體 × deep-guide 隱形大師*
